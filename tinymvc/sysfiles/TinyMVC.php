...
class tmvc
{
  ...
  /* 20140810: Parche para desacoplar los parametros a los controladores */
  var $params = null;
  /**
   * class constructor
   *
  ...
  public function main()
  {
    ...
    $this->config = $config;
    /* 20141008: obtengo parametros de la peticion web */
    $this->setupParams();
    ...
    if($this->config['timer'])
      ob_start();
    /* DL 2014-10-16: auto inicio de sessiones */
    session_start();
  ...
  public function setupController()
  {
    ...
    $this->controller = new $controller_class($this->params,true);
  ...
  /**
   * 20141008: Manejador de parametros
   *
   * @access	public
   */
