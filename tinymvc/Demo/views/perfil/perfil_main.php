...
<input type="hidden" id="Perfil_Id_Usuario" value="<?=$User_Data["ID_USUARIO"];?>"/>
<input type="hidden" id="Perfil_Id_Colegio" value="<?=$User_Data["ID_COLEGIO"];?>"/>
<input type="hidden" id="Perfil_Id_Usuario_Apod" value="<?=$User_Data["ID_USUARIO_APODERADO"];?>"/>
<br />
<table>
	<tr>
	...
	<tr>
		...
		<td colspan="3"><b><?=$User_Data["NOMBRE_COLEGIO"];?></b></td>
	</tr>
</table>
...
<table>
	...
	<tr>
		<td>Telefono Fijo</td>
		<td><input type="text" id="Perfil_Telefono_Fijo" value="<?=$User_Data["NRO_FONO"];?>" disabled="disabled" /></td>
		<td><button id="Perfil_Telefono_Fijo_Button">Editar</button></td>
		<td><div id="Perfil_Telefono_Fijo_Status"><img src="/Demo/images/1413624403_11-128.png" width="15" height="15" style="visibility: hidden;"  /></div></td>
	</tr>	
	<tr>
